...
int totalChocolates(int chocolates,int wrap){
    if(chocolates<wrap){
        return 0;
    }else{
...
int main(){
    ...
    int firstChocolates = rupees/price;
    // wrap = firstChocolates;
    cout<<firstChocolates+totalChocolates(firstChocolates,wrap)<<endl;
}
